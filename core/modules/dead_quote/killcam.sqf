...
_quote = geco_killcam_quotes call tcb_fnc_RandomArrayVal;
_handle = [_quote select 0, _quote select 1, ((missionNameSpace getVariable "geco_respawndelay") - 1)] execVM "core\modules\dead_quote\quote.sqf";;
